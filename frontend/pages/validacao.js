...
const formReceita = document.getElementById("formCadastro")
const receitaBtn = document.getElementById("receitaButton")

receitaBtn.addEventListener('mouseover', function (event) {
    let validado1 = true;
    validações.forEach(validação => {
        if (!validação) {
            validado1 = false;
